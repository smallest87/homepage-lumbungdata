    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        @media (min-width: 992px) {
            ...
            .left-sidebar h2 { /* Gaya untuk judul "Pintasan Anda" di sidebar */
                font-family: 'Montserrat', sans-serif;
                color: #8a8d91; /* Sesuai screenshot */
                font-size: 1em; /* Ukuran lebih kecil sesuai screenshot */
                font-weight: 600;
                margin-bottom: 15px;
                padding: 0 20px;
                width: 100%;
            ...
            .left-sidebar ul li {
                margin-bottom: 0; /* Hapus margin antar list item */
            }
            ...
            .left-sidebar ul li a span.icon {
                ...
                justify-content: center;
                align-items: center;
                color: #8B0000; /* Aksen warna merah untuk ikon */
            }

            .left-sidebar .see-more-toggle {
                display: flex; /* Aktifkan flex untuk see-more */
                align-items: center;
                padding: 10px 20px;
                color: #e4e6eb;
                text-decoration: none;
